...
class TestDataExtractionBMSTable(unittest.TestCase):
    ...
    def test_extract_old_style_bms_table(self):
        ...
        insane = make_dataframe_from_mname(insane_mname, columns=column_name(self.insane_url))
        ...
        overjoy = make_dataframe_from_mname(overjoy_mname, columns=column_name(self.overjoy_url))
        self.assertEqual(tuple(overjoy.iloc[201]),
                         (89, "★5", "FREEDOM DiVE [FOUR DIMENSIONS]",
